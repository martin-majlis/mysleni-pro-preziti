...
Při sledování Popelky jsem si uvědomil, že se nejspíše zdrojem popela nebylo třídění zrní a popela, protože by použila síto, protože síto bylo vymyšleno k třídění zrní a hlíny. Popelka tedy nejspíše používala popel k čištění mastného nádobí nebo k výrobě mýdla, aby mohla prát. Potom mi to došlo.

Když by mi někdo popisoval, jak se mýdlo vyrábí, tak bych nikdy nevěřil tomu, že to může fungovat a spíše bych se ho bál. Na druhou stranu, když by mi někdo vysvětlil myšlenku, na kterých je založená, tak bych věřil tomu, že to fungovat může.
...
1. Vyrobte [potaš](https://cs.wikipedia.org/wiki/Uhli%C4%8Ditan_draseln%C3%BD#Historick%C3%A9_postupy_z%C3%ADsk%C3%A1v%C3%A1n%C3%AD_pota%C5%A1e)
   ...
   2. Popel z dřevěného dřeva nasypejte do kotle a zalijte vodou. Odfiltrujte pevné části.
   3. Topte pod kotlem, aby se voda vyvařila. To, co zůstane na dně je potaš \(pot ash\). 
   4. Z 1kg dřeva získáte 1g potaše.
2. Vyrobte násadu
...
3. Vyrobte mýdlo
   ...
   4. Po schladnutí máte mazlavé mýdlo, které se dá používat.

#### Historie

Již staří Sumerové \(2600 př. n. l.\) vyráběli a používali mýdlo. Odtud se technologie výroby mýdla dostala přes Babylon, Mezopotámii, Egypt do Řecka a později do Říma. Ve 2. století n. l. římský lékař Galén upozornil na výhodý mýdla a začalo se používat k hygieně. Ve 14. století se výroba mýdla rošířena z Itálie a Francie dále do Evropy. V 15. století vznikl v Praze cech mydlářů.
...
Vakcinace je založená na na pár základních skutečnostech:
...
1. Jak funguje buňka:
   ...
   4. Pokud je potřeba něco vyrobit, tak se odpovidající instrukce [přepíše](https://cs.wikipedia.org/wiki/Transkripce_%28DNA%29) z DNA do mRNA.
...
2. Jak funguje koronavirus:
   ...
   2. RNA je sbírka instrukcí, jak vyrobit různé součástky \(a tím pádem celý vir\).
   3. Vir je neživý, nemůže se reagovat na okolí nebo se nějak rozhodovat.
   ...
   6. Po připojení k buňce se uvolní RNA a ten se dostane do buňky.
   7. Buňka místo svých součástek začne vyrábět viry.
   8. Buňka umře a z ní se uvolní viry.
   9. Spousta nových virů může napadnout spoustu nových buněk \(krok 4\).
3. Jak funguje imunita:
   1. Imunitní systém kontroluje všechny věci se zástrčkama.
   2. Imunitní systém ví, které zástrčky patří užitečným věcem \(pro buňky - 1.3\).
   3. Když imunitní systém narazí na neužitečnou zástrčku \(3.2\), tak se podívá, jestli ví, jak vyrábět miny \([protilátky](https://cs.wikipedia.org/wiki/Protil%C3%A1tka)\) s odpovídající zásuvkou.
   ...
   6. Pokud se vir zachytí do zásuvky miny, tak ho mina zničí.
   7. Poznámka 1: Kroky 3.1 až 3.6 umí jenom obratlovci a jedná se o adaptivní mechanismus. Všechny organismy mají také vrozený mechanismus, který dokáže rozponávat a ničit na základě hrubých rysů.
   8. Poznámka 2: Když Evropané dorazili do Ameriky, tak s sebou přinesli Evropské nemoci, na které nebyl imunitní systém Indiánů zvyklý. V prvních 100 letech od objevení zemřelo na nemoci 90% populace, což byl zásadní důvod, proč podlehli Evropanům.
4. Jak funguje střetnutí s virem
   1. Vir se dostane do těla.
   2. Imunitní systém se snaží zjistit zástrčku od viru \(3.3\).
   3. Pokud vir narazí do více buňek \(2.5\) než do antigenů \(3.6\), tak vyhraje vir. V opačném případě vyhraje organizmus.

#### Jak zajistit, aby organismus vyhrál

Ze základů plyne, že pokud má mít člověk větší šanci na výhru při skutečném střetnutí s virem, takže je dobré, aby jeho imunitní systém znal zástrčky \(antigenty\). Díky tomu bude moci začít produkovat miny \(protilátky\) o několik dní dříve.

Když znáte základy, tak určitě máte několik nápadů, jak byste se mohli o něco takové pokusit. Můžete nakazit daného člověka v okamžiku, kdy bude v dobré kondici a budete se moci o něho postarat. Pravé neštovice měly smrtnost 30% a také vedly k permanentnímu znetvoření. V Číně v 10. stol. \(někde se uvádí 2. stol. př. n. l.\), lidé vdechovali usušené nečtovičné strupy. V Turecku používali v 17. století přímo hnis. Tomu se říká variolizace.
...
Může vás napadnout, že buňce podstrčíte instrukce pro výrobu antigenu. Když se vám to povede, tak buňka na svém povrchu vyrobí antigeny typické pro virus. Díky tomu se je imunitní systém naučí rozpoznávat, aniž by přišel do kontaktu se samotným virem. Pokud vás to napadlo, tak jste vynalezli mRNA vakcínu. Gratuluji. Instrukce jsou:
...
Váš další nápad může být, že vezmete nějaký existující vir. Z jeho instrukcí \(RNA\) odstraníte schopnost nekontrolovaně se šířit a naopak tam přidáte instrukce pro výrobu antigenu pro daný virus. Na takovém principu fungují vektorové vakcíny.Postup je následující:
...
* Mýdlo - [https://cs.wikipedia.org/wiki/M%C3%BDdlo](https://cs.wikipedia.org/wiki/M%C3%BDdlo)
